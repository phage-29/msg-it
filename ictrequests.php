                            ...
                            <div class="card-body">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        <button class="nav-link text-primary active" id="nav-open-tab" data-bs-toggle="tab" data-bs-target="#nav-open" type="button" role="tab" aria-controls="nav-open" aria-selected="true">Open <?= $conn->query("SELECT * FROM helpdesks WHERE status='Open'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Open' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-warning" id="nav-pending-tab" data-bs-toggle="tab" data-bs-target="#nav-pending" type="button" role="tab" aria-controls="nav-pending" aria-selected="false">Pending <?= $conn->query("SELECT * FROM helpdesks WHERE status='Pending'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Pending' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-success" id="nav-completed-tab" data-bs-toggle="tab" data-bs-target="#nav-completed" type="button" role="tab" aria-controls="nav-completed" aria-selected="false">Completed <?= $conn->query("SELECT * FROM helpdesks WHERE status='Completed'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Completed' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-secondary" id="nav-denied-tab" data-bs-toggle="tab" data-bs-target="#nav-denied" type="button" role="tab" aria-controls="nav-denied" aria-selected="false">Denied <?= $conn->query("SELECT * FROM helpdesks WHERE status='Denied'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Denied' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-danger" id="nav-unserviceable-tab" data-bs-toggle="tab" data-bs-target="#nav-unserviceable" type="button" role="tab" aria-controls="nav-unserviceable" aria-selected="false">Unserviceable <?= $conn->query("SELECT * FROM helpdesks WHERE status='Unserviceable'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Unserviceable' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-danger" id="nav-cancelled-tab" data-bs-toggle="tab" data-bs-target="#nav-cancelled" type="button" role="tab" aria-controls="nav-cancelled" aria-selected="false">Cancelled <?= $conn->query("SELECT * FROM helpdesks WHERE status='Cancelled'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Cancelled' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                        <button class="nav-link text-info" id="nav-prerepair-tab" data-bs-toggle="tab" data-bs-target="#nav-prerepair" type="button" role="tab" aria-controls="nav-prerepair" aria-selected="false">Pre-Repair <?= $conn->query("SELECT * FROM helpdesks WHERE status='Pre-Repair'")->num_rows > 0 ? '<span class="badge bg-danger small">' . $conn->query("SELECT * FROM helpdesks WHERE status='Pre-Repair' AND RequestedBy=" . $_SESSION['id'] . ")->num_rows . '</span>' : '' ?></button>
                                    </div>
                                </nav>
